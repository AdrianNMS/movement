...
{
    public static Mono<ResponseEntity<Object>> SaveMovement(MovementConditions movCon, Movement mov, MovementService movementService, org.slf4j.Logger log, ParameterService parameterService)
    {
    ...
    public static Mono<ResponseEntity<Object>> UpdateMont(MovementConditions movCon, Movement mov, MovementService movementService, org.slf4j.Logger log, ParameterService parameterService)
    {
    ...
    public static Mono<ResponseEntity<Object>> ObtainMovementPerMonth(MovementConditions movCon, Movement mov, MovementService movementService, org.slf4j.Logger log, ParameterService parameterService)
    {
    ...
    public static Mono<ResponseEntity<Object>> PasiveMovement(MovementConditions movCon, Movement mov, MovementService movementService, org.slf4j.Logger log, ParameterService parameterService)
    {
    ...
    public static Mono<ResponseEntity<Object>> ObtainListParameters(MovementConditions movCon, Movement mov, MovementService movementService, org.slf4j.Logger log, ParameterService parameterService)
    {
    ...
    public static Mono<ResponseEntity<Object>> ObtainMont(MovementConditions movCon, Movement mov, MovementService movementService, org.slf4j.Logger log, ParameterService parameterService)
    {
    ...
    public static Mono<ResponseEntity<Object>> CreateMovementSequence(MovementConditions movCon, Movement mov, MovementService movementService, org.slf4j.Logger log, ParameterService parameterService)
    {
