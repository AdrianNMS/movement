...
{
    public static Mono<ResponseEntity<Object>> UpdateMovement(MovementConditions movCon, Movement mov, MovementService movementService, org.slf4j.Logger log, ParameterService parameterService)
    {
    ...
    public static Mono<ResponseEntity<Object>> CheckOldMont(MovementConditions movCon, Movement mov, MovementService movementService, org.slf4j.Logger log, ParameterService parameterService)
    {
    ...
    public static Mono<ResponseEntity<Object>> UpdateMovementSequence(MovementConditions movCon, Movement mov, MovementService movementService, org.slf4j.Logger log, ParameterService parameterService)
    {
